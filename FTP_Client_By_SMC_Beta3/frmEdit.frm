...
Begin VB.Form frmEdit 
   Caption         =   "Edit Entry From Address Book"
   ClientHeight    =   3960
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
...
DoEvents
DoEvents
    MsgBox "The information has been updated to your address book."
End Sub
...
Private Sub Form_Load()
    ...
    rs.FindFirst "[ID] = " & frmconnect.List1.ItemData(frmconnect.List1.ListIndex)
End Sub
